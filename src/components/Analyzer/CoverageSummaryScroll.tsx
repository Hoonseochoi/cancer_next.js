...
export function CoverageSummaryScroll({ summary }: { summary: AnalysisSummary }) {
    ...
    return (
        <div className="flex flex-col overflow-hidden">
                ...
                titleComponent={
                    <>
                        <h1 className="text-4xl font-semibold text-meritz-text dark:text-white">
                            암치료비 한눈에 보기 <br />
                            <span className="text-4xl md:text-6xl font-bold mt-1 leading-none text-meritz-red">
                                보장 분석 요약
                            </span>
                        </h1>
                    </>
            ...
            >
                <div id="summary-content-grid" className="grid grid-cols-2 gap-4 p-4 h-full bg-white dark:bg-black rounded-2xl overflow-y-auto">
